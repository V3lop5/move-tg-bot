...
val allowPersonalShareRequirement = Requirement("Dieser Befehl kann nur genutzt werden, wenn du selber ein Vorstellungsvideo aufgenommen hast und dieses mit den anderen Teilnehmern teilst.") { user, _, _ -> ChallengerManager.findChallenger(user)?.shareVideoAndGoals?:false }
